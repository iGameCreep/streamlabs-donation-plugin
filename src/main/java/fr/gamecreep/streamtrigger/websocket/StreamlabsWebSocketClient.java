package fr.gamecreep.streamtrigger.websocket;
...
public class StreamlabsWebSocketClient {
    ...
    public StreamlabsWebSocketClient(final StreamTrigger plugin, final String wsToken) throws WebSocketException {
        this.plugin = plugin;
