...
import fr.gamecreep.fundraiserfusion.external.streamlabs.api.streamlabs.StreamLabsDonationEvent;
import fr.gamecreep.fundraiserfusion.external.streamlabs.api.twitch.*;
import fr.gamecreep.fundraiserfusion.external.streamlabs.api.youtube.YoutubeFollowEvent;
import fr.gamecreep.fundraiserfusion.external.streamlabs.api.youtube.YoutubeMembershipGift;
import fr.gamecreep.fundraiserfusion.external.streamlabs.api.youtube.YoutubeSubscriptionEvent;
import fr.gamecreep.fundraiserfusion.external.streamlabs.api.youtube.YoutubeSuperChatEvent;
